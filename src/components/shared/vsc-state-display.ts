...
import type { UpdateEntity } from '../../ha/data/update';

import { computeStateDomain, computeStateName } from '../../ha';
import { isUnavailableState } from '../../ha';
import { ensureArray } from '../../ha/common/array/ensure-array';
import { SENSOR_DEVICE_CLASS_TIMESTAMP } from '../../ha/data/sensor';
import { computeUpdateStateDisplay } from '../../ha/data/update';
...
@customElement('vsc-state-display')
class VscStateDisplay extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'vsc-state-display': VscStateDisplay;
  }
}
